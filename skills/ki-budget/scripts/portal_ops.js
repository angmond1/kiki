// ============================================================
// ki-budget 코어 — KIST 통합정보 예실대비표 조회 (window.kiBudget)
// ------------------------------------------------------------
...
//   Read -> javascript_tool 로 inject -> window.kiBudget.* 호출.
...
(function () {
  ...
  window.kiBudget = {
    ...
    _version: 'ki-budget-portal/1.0',
  };
  return window.kiBudget._version;
})();
